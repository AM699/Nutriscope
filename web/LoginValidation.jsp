...
<html>
    ...
    <%
            ...
            else userName = (String) session.getAttribute("first");
				...
				<div class="header-left">
					<div class="logo">
						<a href="index.html">Nutriscope</a>
                                    ...
                                    <h3> <font size='5' color=#59193A> Hi <%=userName %>, Validation successful!</font></h3>
				</div>
						...
						<li><a href=#>Messages</a></li> 
                                                <li> 
                                                     ...
                                                     <form id="loginForm" action="<%=response.encodeURL("LogOut") %>" method="POST" >
                                                              <input type="submit" id="login" value="LogOut"  style="width:80px; height:40px; float:right; position:relative;  " />
			...
			<div class="content" >
				...
				<div class="content-feature-grids">
					...
					<div class="feature-grid">
						...
						<div class="feature-grid-right">
							<h2><a href="SearchClient.html" style="position:relative; top:120px; right:-85px"><span>Search Client</span></a></h2>
					...
					<div class="feature-grid">
						...
						<div class="feature-grid-right">
							<h2><a href="#" style="position:relative; top:120px; right:-60px"><span>Create Food Plan</span></a></h2>
